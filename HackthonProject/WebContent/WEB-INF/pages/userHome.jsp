		...
		<div class="searchRes_container ">
			...
			<div class="paneR">
				...
				<div class="results_container">
					<!-- <div id="submitall">
						<input  width="60%" class="booklistcheckboxall" type="checkbox" name="vehicle"
							value="1" />
						<form action="" width="40%">
							<button type="submit" class="booklistsubmit">SUBMIT ALL</button>
						</form>
					</div> -->
						...
						<tbody>
							<tr valign="top">
								<td class="searchRes_number" width="6%">
									...
									class="booklistcheckboxall" type="checkbox" name="vehicle"
									value="1" />
								</td>
								<td width="45%">
								...
								<td width="45%" style="float: right">
									<div style="width: 100%;">
										<form action="">
											<button type="submit" class="booklistsubmit">SUBMIT
												ALL</button>
										</form>
									</div>
								</td>
